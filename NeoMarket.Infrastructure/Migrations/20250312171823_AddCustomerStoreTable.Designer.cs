...
namespace NeoMarket.Infrastructure.Migrations
{
    ...
    [Migration("20250312171823_AddCustomerStoreTable")]
    partial class AddCustomerStoreTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NeoMarket.Domain.Entities.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NeoMarket.Domain.Entities.CustomerStore", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NeoMarket.Domain.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NeoMarket.Domain.Entities.Subcategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Product", b =>
                {
                    b.HasOne("NeoMarket.Domain.Entities.Brand", "Brand")
                        .WithMany("Products")
                    ...
                    b.HasOne("NeoMarket.Domain.Entities.Subcategory", "Subcategory")
                        .WithMany("Products")
